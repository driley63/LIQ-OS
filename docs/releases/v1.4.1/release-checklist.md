...
- [x] Button, link, focus, table, navigation, and footer styling align with released Design Language rules where MkDocs allows.
- [x] Asset inventory records documentation-site logo exports.
- [x] Promote v1.4.1 from draft to released after PR approval and merge.
