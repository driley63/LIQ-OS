...
Defines the visual rules for app and domain icons.
...
- Use a consistent rounded, optimistic icon style.
- Domain icons must reinforce health categories.
- AI icons must follow the purple reservation rule.
