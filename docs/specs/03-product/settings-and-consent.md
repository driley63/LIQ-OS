...
Defines settings and consent for Product Experience.
...
- Settings And Consent must support the LifestyleIQ philosophy.
- Settings And Consent must be consistent with approved brand and design tokens where relevant.
- Settings And Consent must identify affected platforms, users, and maintainers.
