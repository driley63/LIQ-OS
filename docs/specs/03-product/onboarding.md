...
Defines onboarding for Product Experience.
...
- Onboarding must support the LifestyleIQ philosophy.
- Onboarding must be consistent with approved brand and design tokens where relevant.
- Onboarding must identify affected platforms, users, and maintainers.
