...
Defines routing for Engineering Standards.
...
- Routing must support the LifestyleIQ philosophy.
- Routing must be consistent with approved brand and design tokens where relevant.
- Routing must identify affected platforms, users, and maintainers.
