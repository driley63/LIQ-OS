...
Defines release engineering for Engineering Standards.
...
- Release Engineering must support the LifestyleIQ philosophy.
- Release Engineering must be consistent with approved brand and design tokens where relevant.
- Release Engineering must identify affected platforms, users, and maintainers.
