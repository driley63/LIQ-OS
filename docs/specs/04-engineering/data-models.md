...
Defines data models for Engineering Standards.
...
- Data Models must support the LifestyleIQ philosophy.
- Data Models must be consistent with approved brand and design tokens where relevant.
- Data Models must identify affected platforms, users, and maintainers.
