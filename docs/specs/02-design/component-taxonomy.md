...
Defines component taxonomy for Design Language.
...
- Component Taxonomy must support the LifestyleIQ philosophy.
- Component Taxonomy must be consistent with approved brand and design tokens where relevant.
- Component Taxonomy must identify affected platforms, users, and maintainers.
