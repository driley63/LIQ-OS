...
Defines iconography for Design Language.
...
- Iconography must support the LifestyleIQ philosophy.
- Iconography must be consistent with approved brand and design tokens where relevant.
- Iconography must identify affected platforms, users, and maintainers.
