...
Defines inputs for Design Language.
...
- Inputs must support the LifestyleIQ philosophy.
- Inputs must be consistent with approved brand and design tokens where relevant.
- Inputs must identify affected platforms, users, and maintainers.
