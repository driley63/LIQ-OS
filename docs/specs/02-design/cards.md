...
Defines cards for Design Language.
...
- Cards must support the LifestyleIQ philosophy.
- Cards must be consistent with approved brand and design tokens where relevant.
- Cards must identify affected platforms, users, and maintainers.
