...
Defines motion for Design Language.
...
- Motion must support the LifestyleIQ philosophy.
- Motion must be consistent with approved brand and design tokens where relevant.
- Motion must identify affected platforms, users, and maintainers.
