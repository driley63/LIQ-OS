...
Defines ai product principles for AI Principles.
...
- Ai Product Principles must support the LifestyleIQ philosophy.
- Ai Product Principles must be consistent with approved brand and design tokens where relevant.
- Ai Product Principles must identify affected platforms, users, and maintainers.
