...
Defines evaluation for AI Principles.
...
- Evaluation must support the LifestyleIQ philosophy.
- Evaluation must be consistent with approved brand and design tokens where relevant.
- Evaluation must identify affected platforms, users, and maintainers.
