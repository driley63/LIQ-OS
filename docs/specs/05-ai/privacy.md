...
Defines privacy for AI Principles.
...
- Privacy must support the LifestyleIQ philosophy.
- Privacy must be consistent with approved brand and design tokens where relevant.
- Privacy must identify affected platforms, users, and maintainers.
