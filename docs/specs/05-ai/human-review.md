...
Defines human review for AI Principles.
...
- Human Review must support the LifestyleIQ philosophy.
- Human Review must be consistent with approved brand and design tokens where relevant.
- Human Review must identify affected platforms, users, and maintainers.
