...
Defines insight types for AI Principles.
...
- Insight Types must support the LifestyleIQ philosophy.
- Insight Types must be consistent with approved brand and design tokens where relevant.
- Insight Types must identify affected platforms, users, and maintainers.
