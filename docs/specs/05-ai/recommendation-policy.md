...
Defines recommendation policy for AI Principles.
...
- Recommendation Policy must support the LifestyleIQ philosophy.
- Recommendation Policy must be consistent with approved brand and design tokens where relevant.
- Recommendation Policy must identify affected platforms, users, and maintainers.
