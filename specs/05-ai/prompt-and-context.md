...
Defines prompt and context for AI Principles.
...
- Prompt And Context must support the LifestyleIQ philosophy.
- Prompt And Context must be consistent with approved brand and design tokens where relevant.
- Prompt And Context must identify affected platforms, users, and maintainers.
