...
Defines failure states for AI Principles.
...
- Failure States must support the LifestyleIQ philosophy.
- Failure States must be consistent with approved brand and design tokens where relevant.
- Failure States must identify affected platforms, users, and maintainers.
