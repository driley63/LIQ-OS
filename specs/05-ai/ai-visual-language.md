...
Defines ai visual language for AI Principles.
...
- Ai Visual Language must support the LifestyleIQ philosophy.
- Ai Visual Language must be consistent with approved brand and design tokens where relevant.
- Ai Visual Language must identify affected platforms, users, and maintainers.
