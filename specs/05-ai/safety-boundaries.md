...
Defines safety boundaries for AI Principles.
...
- Safety Boundaries must support the LifestyleIQ philosophy.
- Safety Boundaries must be consistent with approved brand and design tokens where relevant.
- Safety Boundaries must identify affected platforms, users, and maintainers.
