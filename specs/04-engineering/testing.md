...
Defines testing for Engineering Standards.
...
- Testing must support the LifestyleIQ philosophy.
- Testing must be consistent with approved brand and design tokens where relevant.
- Testing must identify affected platforms, users, and maintainers.
