...
Defines accessibility testing for Engineering Standards.
...
- Accessibility Testing must support the LifestyleIQ philosophy.
- Accessibility Testing must be consistent with approved brand and design tokens where relevant.
- Accessibility Testing must identify affected platforms, users, and maintainers.
