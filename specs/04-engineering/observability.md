...
Defines observability for Engineering Standards.
...
- Observability must support the LifestyleIQ philosophy.
- Observability must be consistent with approved brand and design tokens where relevant.
- Observability must identify affected platforms, users, and maintainers.
