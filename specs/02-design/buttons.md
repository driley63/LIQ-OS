...
Defines buttons for Design Language.
...
- Buttons must support the LifestyleIQ philosophy.
- Buttons must be consistent with approved brand and design tokens where relevant.
- Buttons must identify affected platforms, users, and maintainers.
