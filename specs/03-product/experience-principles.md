...
Defines experience principles for Product Experience.
...
- Experience Principles must support the LifestyleIQ philosophy.
- Experience Principles must be consistent with approved brand and design tokens where relevant.
- Experience Principles must identify affected platforms, users, and maintainers.
