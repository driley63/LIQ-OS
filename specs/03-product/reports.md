...
Defines reports for Product Experience.
...
- Reports must support the LifestyleIQ philosophy.
- Reports must be consistent with approved brand and design tokens where relevant.
- Reports must identify affected platforms, users, and maintainers.
