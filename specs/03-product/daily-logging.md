...
Defines daily logging for Product Experience.
...
- Daily Logging must support the LifestyleIQ philosophy.
- Daily Logging must be consistent with approved brand and design tokens where relevant.
- Daily Logging must identify affected platforms, users, and maintainers.
