...
Defines notification guidance for Product Experience.
...
- Notification Guidance must support the LifestyleIQ philosophy.
- Notification Guidance must be consistent with approved brand and design tokens where relevant.
- Notification Guidance must identify affected platforms, users, and maintainers.
