...
Defines health language for Product Experience.
...
- Health Language must support the LifestyleIQ philosophy.
- Health Language must be consistent with approved brand and design tokens where relevant.
- Health Language must identify affected platforms, users, and maintainers.
