...
Defines user research for Product Experience.
...
- User Research must support the LifestyleIQ philosophy.
- User Research must be consistent with approved brand and design tokens where relevant.
- User Research must identify affected platforms, users, and maintainers.
